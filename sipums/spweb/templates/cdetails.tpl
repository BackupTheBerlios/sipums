           ...
           <CENTER>
               <TABLE class="MTable" valign=top> 
                   ...
                   <TR><TD><!--{$item.invitee_name}--></td><td><!--{$item.invitee_email}--></td>
                     <!--{if $conf.owner_flag}--><TD><a href="resend_email.php?conference_id=<!--{$conf.conference_id}-->&invitee_id=<!--{$item.invitee_id}-->">Resend Email</a>
                       </TD><!--{/if}--> 
                            </tr>
                   <!--{/foreach}-->
                   <!--{if $conf.owner_flag}-->
                   <TR> <TD colspan=2 align=center>
                      <a href='add_invitee.php?conference_id=<!--{$conf.conference_id}-->'>Add an Invitee</a>
                     </td></tr>
                    <!--{/if}-->
