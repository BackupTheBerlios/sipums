...
var WindowTitle ="Conference Date Picker";//Date Time Picker title.
...
function RenderCal()
{
	...
	docCal.writeln("<LINK REL=\"StyleSheet\" HREF=\"style/styles.css\" TYPE=\"text/css\">"); 
	docCal.writeln("</head><body background='"+ThemeBg+"' link="+FontColor+" vlink="+FontColor+"><form name='Calendar'>");

	vCalHeader="<table border=1 class='MTable' width='100%' align=\"center\" valign=\"top\">\n";
	//Month Selector
